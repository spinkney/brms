...
test_that("multiple ordinal S2Z blocks share one weighted dense solve", {
  ...
  expect_match2(code, "group_info_s2z_1 = 1.0 * N_1;")
  expect_match2(code, "group_info_s2z_2 = sum(group_prec_s2z_2);")
  ...
  expect_match2(code, "P_s2z_1[2 + k, 2 + k] += group_info_s2z_2;")
